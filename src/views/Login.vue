                  ...
                  <v-row>
                    <v-col cols="12" md="8">
                      <v-card-text class="mt-12">
                        <h1 class="text-center display-2 light-blue--text mb-3">Login <strong>DNM Mobile</strong></h1>
                        <v-form>
...
export default {
  ...
  metaInfo: {
		title: "Login Administrator - DNM Mobile",
		htmlAttrs: {
			lang: "id",
			amp: true,
		},
  ...
  methods: {
    ...
    async AutentificationLogin(){
      ...
      .then((res) => {
        ...
        localStorage.setItem('roleID', data.result.level);
